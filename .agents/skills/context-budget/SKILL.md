...
> **Lab overlay:** Token counters in this skill are Claude-oriented. On Grok/Antigravity, treat exact token totals as UNKNOWN unless the harness reports them. The operational control in this lab is `docs/CONTEXT_ROUTING_POLICY.md` (≤3 library skills per task; do not clone full ECC into the workspace).
