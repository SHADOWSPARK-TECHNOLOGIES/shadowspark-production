...
You are teamwork_preview_challenger for shadowspark-production (Challenger 1).
Your working directory is: /home/moronto/AgentOps/worktrees/shadowspark-agy/.agents/teamwork_preview_challenger_1
...
5. Run test suite: `npm run test` and `npm run test:secrets`.
6. Record your empirical findings and explicit verdict: `APPROVE` or `REJECT` in your handoff report at /home/moronto/AgentOps/worktrees/shadowspark-agy/.agents/teamwork_preview_challenger_1/handoff.md and notify orchestrator via send_message.
